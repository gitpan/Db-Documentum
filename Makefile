...
#	AUTHOR => q[Brian Spolarich (briansp@acm.org) and M. Scott Roth (michael.s.roth@saic.com)]
#	DEFINE => q[-DSQLNETV2 -DSYSV -D$OS -DOS_UNIX]
#	INC => q[-I"c:\program files\documentum\shared" -IC:\Program Files\Microsoft Visual Studio\VC98\atl\include -IC:\Program Files\Microsoft Visual Studio\VC98\mfc\include -IC:\Program Files\Microsoft Visual Studio\VC98\include]
#	LIBS => [q[-L"c:\program files\documentum\shared" -ldmcl40.lib  -LC:\Program Files\Microsoft Visual Studio\VC98\mfc\lib -LC:\Program Files\Microsoft Visual Studio\VC98\lib]]
...
INC = -I"c:\program files\documentum\shared" -IC:\Program Files\Microsoft Visual Studio\VC98\atl\include -IC:\Program Files\Microsoft Visual Studio\VC98\mfc\include -IC:\Program Files\Microsoft Visual Studio\VC98\include
...
realclean purge ::  clean
	...
	$(PERL) -I$(PERL_ARCHLIB) -I$(PERL_LIB) -MExtUtils::Command -e rm_f $(INST_LIBDIR)\Documentum\Tools.pm $(INST_LIBDIR)\Documentum\Tools.html $(INST_LIBDIR)\Documentum.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Db-Documentum\" VERSION=\"1,5,0,0\">\n}. qq{\t<TITLE>Db-Documentum</TITLE>\n}. qq{\t<ABSTRACT>Perl extension for Documentum Client Libraries.</ABSTRACT>\n}. qq{\t<AUTHOR>Brian Spolarich (briansp\@acm.org) and M. Scott Roth (michael.s.roth\@saic.com)</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"MSWin32-x86-multi-thread\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Db-Documentum.ppd
